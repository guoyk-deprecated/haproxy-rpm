...
%{__install} -p -D -m 0644 %{SOURCE1} %{buildroot}%{_sysconfdir}/%{name}/%{name}.cfg
%{__install} -p -D -m 0644 %{SOURCE2} %{buildroot}%{_sysconfdir}/logrotate.d/%{name}
%{__install} -c -m 755 %{SOURCE3} %{buildroot}%{_sysconfdir}/rc.d/init.d/%{name}
...
%changelog
* Mon Apr 09 2018 Yanke Guo <guoyk.cn@gmail.com>
- customized 1.8.7
